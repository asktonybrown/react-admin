...
const Users = () => {
  ...
  const [data, setData] = useState([
    ...
    {id:2,name:"Catherine Manseau",image:Avatar_02,email:"catherinemanseau@example.com",company:"dreamguy's technology",created_date:"5 Jan 2019",role:"Admin"},
    {id:3,name:"Jeffery Lalor",image:Avatar_03,email:"jefferrylalorr@example.com",company:"dreamguy's technology",created_date:"5 Jan 2019",role:"Employee"},
    ...
    {id:5,name:"John Due",image:Avatar_05,email:"johndue@example.com",company:"dreamguy's technology",created_date:"14 Jan 2019",role:"Employee"},
    {id:6,name:"John Smith",image:Avatar_06,email:"johnsmith@example.com",company:"dreamguy's technology",created_date:"14 Jan 2019",role:"Employee"},
    {id:7,name:"Lesley Grauer",image:Avatar_07,email:"lesleygrauer@example.com",company:"dreamguy's technology",created_date:"14 Jan 2019",role:"Employee"},
    {id:8,name:"Loren Gatlin",image:Avatar_08,email:"lorengatlin@example.com",company:"dreamguy's technology",created_date:"14 Jan 2019",role:"Employee"},
    {id:9,name:"Mike Litorus",image:Avatar_09,email:"mikelitorus@example.com",company:"dreamguy's technology",created_date:"14 Jan 2019",role:"Employee"},
    {id:10,name:"Richard Miles",image:Avatar_10,email:"richardmiles@example.com",company:"dreamguy's technology",created_date:"14 Jan 2019",role:"Employee"},
    {id:11,name:"Tarah Shropshire",image:Avatar_11,email:"tarahshropshire@example.com",company:"dreamguy's technology",created_date:"14 Jan 2019",role:"Employee"},
    {id:12,name:"Wilmer Deluna",image:Avatar_12,email:"wilmerdeluna@example.com",company:"dreamguy's technology",created_date:"14 Jan 2019",role:"Employee"},
  ]);
  useEffect( ()=>{
    if($('.select').length > 0) {
      $('.select').select2({
